...
const Sidebar: React.FC = () => {
  ...
  return (
    <div className="lg:sidebar bg-[#132d46] text-white w-full lg:min-w-56 min-h-32 lg:min-h-screen flex flex-col justify-between px-4 py-8 shadow-3xl shadow-[#49e9dd] border-r-2 border-[#1b5a71] font-Montserrat">
